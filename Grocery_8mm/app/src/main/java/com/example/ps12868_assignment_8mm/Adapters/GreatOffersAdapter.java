...
public class GreatOffersAdapter extends RecyclerView.Adapter<GreatOffersAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        Glide.with(context).load(greatOffersModel.getShop_img()).into(holder.shopImg);
