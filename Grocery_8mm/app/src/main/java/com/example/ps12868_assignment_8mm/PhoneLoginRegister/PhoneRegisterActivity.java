    ...
    private void init() {
        ...
        callbacks = new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
            ...
            public void onVerificationFailed(@NonNull FirebaseException e) {
                ...
                Toast.makeText(PhoneRegisterActivity.this, "Số điện thoại không hợp lệ\n" + e.getMessage(), Toast.LENGTH_SHORT).show();
            }
            ...
            public void onCodeSent(@NonNull String verificationId, @NonNull PhoneAuthProvider.ForceResendingToken token) {
                ...
                Toast.makeText(PhoneRegisterActivity.this, "Mã đã được gửi, vui lòng kiểm tra và xác minh", Toast.LENGTH_SHORT).show();
            ...
            public void onClick(View view) {
                ...
                if (user_phone.length() != 10) {
                    ...
                    PhoneAuthProvider.getInstance().verifyPhoneNumber(
                            ...
                            PhoneRegisterActivity.this,                     //Activity (Cho ràng buộc callbacks)
        ...
        btnOtp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (otp.getText().toString().equals("")) {
                    Toast.makeText(PhoneRegisterActivity.this, "Vui lòng nhập 6 số OTP của bạn.", Toast.LENGTH_SHORT).show();
                }
                if (otp.getText().toString().length() != 6) {
                    Toast.makeText(PhoneRegisterActivity.this, "OTP không hợp lệ.", Toast.LENGTH_SHORT).show();
                }
                else {
                    dialog.setVisibility(View.VISIBLE);
                ...
                .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(PhoneRegisterActivity.this, "Đã xảy ra lỗi. Vui lòng thử lại!", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
    }
...
//                }
                    ...
                    Toast.makeText(PhoneRegisterActivity.this, "Phone này đã tồn tại, Vui lòng thử một Phone khác", Toast.LENGTH_SHORT).show();
                    dialog.setVisibility(View.GONE);
                }
            }
